...
Blockly.Xml.domToBlock = function(a, b) {
    ...
    try {
        ...
        if (b.rendered) {
            ...
            setTimeout(function() {
                console.log('domToBlock--setTimeout');
...
Blockly.Gesture.prototype.handleMove = function(a) {
    // console.log('getstureHandleMove', a);
    // console.log('path----', $(a.target).getPath());
...
Blockly.Gesture.prototype.handleUp = function(a) {
    // console.log('Blockly.Gesture.prototype.handleUp', a);
    this.updateFromEvent_(a);
    Blockly.longStop_();
...
Blockly.TouchGesture.prototype.handleMove = function(a) {
    // console.log('touchGestureHandleMove', a);
    // console.log('path----', $(a.target).getPath());
    // return;
...
Blockly.FieldTextInput.prototype.onHtmlInputKeyDown_ = function(a) {
    ...
    // console.log('onHtmlInputKeyDown_--value', b);
    // console.log('onHtmlInputKeyDown_---e', a)
        ...
        if (!e.isDragging()) {
            ...
            if (c.contentTop < f || c.contentTop +
                ...
                for (var m = !1, p = 0, q; q = l[p]; p++) {
                    var r = q.getRelativeToSurfaceXY(),
                        t = q.getHeightWidth(),
                        u = f + 25 - t.height - r.y;
